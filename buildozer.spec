...
title = Factory Manager Pro

# (str) Package name
package.name = factorymanager

# (str) Package domain (needed for android/ios packaging)
package.domain = com.factorymanager.app

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,ttf,json,db,sql

# (list) List of inclusions using pattern matching
source.include_patterns = assets/*,images/*.png,fonts/*.ttf,data/*.json

# (list) Source files to exclude (let empty to not exclude anything)
#source.exclude_exts = spec

# (list) List of directory to exclude (let empty to not exclude anything)
source.exclude_dirs = tests, bin, venv, .venv, __pycache__, .git, .github, .idea, build, dist
...
# (list) Permissions
# Android 13+ (API 33) requiere permisos específicos para almacenamiento
android.permissions = INTERNET, WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE, MANAGE_EXTERNAL_STORAGE, ACCESS_NETWORK_STATE, WAKE_LOCK, VIBRATE
...
# (str) Full path to a custom AndroidManifest.xml
#android.manifest_path =

# (str) Java package name of the project
...
# To avoid the screen going off while importing large files or long calculations
...
# (str) Android gradle plugin to use. Please specify the full path and version.
#android.gradle_plugin =

# (list) Android Java classes to extend activity classes
#android.add_activities =

# (str) Android activity Java class to extend activity classes
#android.activity_java_class =

# (str) Android service Java class to extend service classes
#android.service_java_class =

# (list) Copy these files to src/main/res/xml/ (used for things like FileProvider)
#android.res_xml = path/to/file.xml

# (str) FileProvider authority (para compartir archivos en Android 7+)
android.fileprovider_authority = com.factorymanager.app.fileprovider
...
# (str) URL pointing to an icon (57x57) to be displayed during download
# This option should be defined along with `app_url` and `full_size_image_url` options.
#ios.manifest.display_image_url =

# (str) URL pointing to a large icon (512x512) to be used by iTunes
